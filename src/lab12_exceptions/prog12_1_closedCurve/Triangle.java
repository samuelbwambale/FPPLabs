...
import lab12_exceptions.prog12_1_closedCurve.exceptions.IllegalTriangleException;
...
public class Triangle extends ClosedCurve {
	...
	public Triangle(double side1, double side2, double side3) throws IllegalTriangleException  {
			...
			if(x < 0 || y < 0 || z < 0) {
				...
				throw new IllegalTriangleException("Illegal non-positive value for side");
			}
			else if(x + y < z) {
